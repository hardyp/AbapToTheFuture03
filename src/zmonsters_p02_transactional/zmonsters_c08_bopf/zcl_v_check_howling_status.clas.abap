class ZCL_V_CHECK_HOWLING_STATUS definition
  public
...
CLASS ZCL_V_CHECK_HOWLING_STATUS IMPLEMENTATION.


METHOD /bobf/if_frw_validation~execute.
*--------------------------------------------------------------------*
* Listing 08.19 - Coding an Action Validation
*--------------------------------------------------------------------*
* Local Variables
...
* Get the current header values
    ...
    CHECK bopf_monster_header_record-monster_number IS NOT INITIAL.
...
* Use the model to actually perform the logic check
        ...
        monster_model->validate_howl_action( external_monster_header_record ).
...
* Now we send an error message in the format the BOPF Framework desires
  ...
  ENDMETHOD."EXECUTE of ZCL_V_CHECK_HOWLING_STATUS
ENDCLASS.
