class ZCL_Z_MONSTER_DELIVERY_DPC definition
  public
...
protected section.
  ...
  methods I_DRAFTADMINISTR_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_MONSTER_DELIVERY_MPC=>TS_I_DRAFTADMINISTRATIVEDATATY
    raising
  ...
  methods I_DRAFTADMINISTR_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_MONSTER_DELIVERY_MPC=>TT_I_DRAFTADMINISTRATIVEDATATY
  ...
  methods I_DRAFTADMINISTR_UPDATE_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZCDS_MONSTER_DEL_CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_Z_MONSTER_DELIVERY_MPC=>TS_ZCDS_MONSTER_DELIVERIESTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZCDS_MONSTER_DEL_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZCDS_MONSTER_DEL_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZCDS_MONSTER_DEL_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_Z_MONSTER_DELIVERY_MPC=>TT_ZCDS_MONSTER_DELIVERIESTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZCDS_MONSTER_DEL_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
CLASS ZCL_Z_MONSTER_DELIVERY_DPC IMPLEMENTATION.
...
*&* This class has been generated on 10.08.2018 21:00:36 in client 249
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_MONSTER_DELIVERY_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA i_draftadministr_create_entity TYPE zcl_z_monster_delivery_mpc=>ts_i_draftadministrativedataty.
 DATA zcds_monster_del_create_entity TYPE zcl_z_monster_delivery_mpc=>ts_zcds_monster_deliveriestype.
...
*-------------------------------------------------------------------------*
*             EntitySet -  ZCDS_MONSTER_DELIVERIES
*-------------------------------------------------------------------------*
     WHEN 'ZCDS_MONSTER_DELIVERIES'.
*     Call the entity set generated method
    zcds_monster_del_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = zcds_monster_del_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = zcds_monster_del_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
      when 'ZCDS_MONSTER_DELIVERIES'.
*     Call the entity set generated method
     zcds_monster_del_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA i_draftadministr_get_entity TYPE zcl_z_monster_delivery_mpc=>ts_i_draftadministrativedataty.
 DATA zcds_monster_del_get_entity TYPE zcl_z_monster_delivery_mpc=>ts_zcds_monster_deliveriestype.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          zcds_monster_del_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zcds_monster_del_get_entity
                         es_response_context = es_response_context
          ).

        IF zcds_monster_del_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zcds_monster_del_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_MONSTER_DELIVERY_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA i_draftadministr_get_entityset TYPE zcl_z_monster_delivery_mpc=>tt_i_draftadministrativedataty.
 DATA zcds_monster_del_get_entityset TYPE zcl_z_monster_delivery_mpc=>tt_zcds_monster_deliveriestype.
 DATA lv_entityset_name TYPE string.
...
*-------------------------------------------------------------------------*
   WHEN 'ZCDS_MONSTER_DELIVERIES'.
*     Call the entity set generated method
      zcds_monster_del_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = zcds_monster_del_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = zcds_monster_del_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA i_draftadministr_update_entity TYPE zcl_z_monster_delivery_mpc=>ts_i_draftadministrativedataty.
 DATA zcds_monster_del_update_entity TYPE zcl_z_monster_delivery_mpc=>ts_zcds_monster_deliveriestype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*-------------------------------------------------------------------------*
      WHEN 'ZCDS_MONSTER_DELIVERIES'.
*     Call the entity set generated method
          zcds_monster_del_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zcds_monster_del_update_entity
          ).
       IF zcds_monster_del_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zcds_monster_del_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    ...
    TYPES ty_zcds_monster_deliveries_2 TYPE zcds_monster_deliveries ##NEEDED. " reference for where-used list
    TYPES ty_zmn_draft_dels_3 TYPE zmn_draft_dels ##NEEDED. " reference for where-used list
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20180810130020
               iv_uuid              = 'Z_MONSTER_DELIVERY_CDS_PULL'
  ...
  method ZCDS_MONSTER_DEL_CREATE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->create_entity( EXPORTING io_data_provider        = io_data_provider
                                                             io_tech_request_context = io_tech_request_context
                                                   IMPORTING es_data                 = er_entity ).
  endmethod.
  ...
  method ZCDS_MONSTER_DEL_DELETE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->delete_entity( io_tech_request_context ).
  endmethod.


  method ZCDS_MONSTER_DEL_GET_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->get_entity( EXPORTING io_tech_request_context = io_tech_request_context
                                                IMPORTING es_data                 = er_entity ).
  endmethod.


  method ZCDS_MONSTER_DEL_GET_ENTITYSET.
    if_sadl_gw_dpc_util~get_dpc( )->get_entityset( EXPORTING io_tech_request_context = io_tech_request_context
                                                   IMPORTING et_data                 = et_entityset
                                                             es_response_context     = es_response_context ).
  endmethod.
  ...
  method ZCDS_MONSTER_DEL_UPDATE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->update_entity( EXPORTING io_tech_request_context = io_tech_request_context
                                                             io_data_provider        = io_data_provider
                                                   IMPORTING es_data                 = er_entity ).
  endmethod.
